<template>
      <!--Flyout Menu (Starts) -->
    <div class="border absolute z-10 inset-x-0 transform shadow-lg">
        <div class="absolute inset-0 flex" aria-hidden="true">
            <div class="bg-white w-1/2"></div>
            <div class="bg-gray-50 w-1/2"></div>
        </div>
        <div v-if="isVisible==true" @focus="showMenu" @mouseleave="hideMenu" class="relative max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-2">
