            ...
            <div class="w-screen max-w-md">
                <div class="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-2xl">
                        ...
                        <header class="space-y-1 py-6 px-4 bg-yellow-700 sm:px-6">
                            <div class="flex items-center justify-between space-x-3">
                                ...
                                <div class="h-7 flex items-center">
                                    <button v-on:click="isContactFormVisible=false" aria-label="Close panel" class="text-yellow-200 hover:text-white transition ease-in-out duration-150">
                                                ...
                                                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                                    ...
                                                    <div class="sm:col-span-6">
                                                     ...
                                                     <div class="sm:col-span-6">
                                                        ...
                                                        name="Product" label="Reason for contacting  *" 
                    ...
                    <div class="w-full flex-shrink-0 px-4 py-4 space-x-4 flex justify-end">
                        ...
                        <span class="inline-flex rounded-md shadow-sm">
                            <button v-on:click="sendContactUs" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent text-sm leading-5 font-medium  text-white bg-yellow-600 hover:bg-yellow-500 focus:outline-none focus:border-green-700 focus:shadow-outline-green active:bg-yellow-700 transition duration-150 ease-in-out">
                                Save
                            </button>
                        </span>
                    </div>
