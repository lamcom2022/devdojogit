                    ...
                    <div class="h-full relative" style="min-height: 12rem;">
                        <div class="absolute inset-0">
                            <nav class="px-2 space-y-1 pt-5" id="doc-left-nav">
                                <NuxtLink v-for="item of menu" :key="item.path" :to="item.path" class="border-transparent text-gray-500 hover:bg-yellow-400 hover:text-gray-900 group flex items-center px-3 py-2 text-md font-medium border-l-4">
                                    <span class="truncate">
                                        {{ item.title }}
                                    </span>
                                </NuxtLink>
                        ...
                        <li class="overflow-hidden px-6">
                            ...
                            <div class="border relative" style="min-height: 36rem;">
                                <div class="flex-1 max-h-screen xl:overflow-y-auto">
                                    <div class="inset-0">
                                        <article class="max-w-full pl-5 prose md:prose-lg">
                        ...
                        <li class="overflow-hidden py-4">
                            <div class="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
                                <div class="flex-1 min-w-0">
                                    <NuxtLink v-if="prev" :to="prev.path" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium text-gray-600 bg-yellow-300 hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                ...
                                <div class="mt-4 flex sm:mt-0 sm:ml-4">
                                    <NuxtLink v-if="next" :to="next.path" class="inline-flex object-none object-right-top items-center px-6 py-3 border border-transparent text-base font-medium text-gray-600 bg-yellow-300 hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                        {{ next.title }}
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="h-full relative" style="min-height: 16rem;">
                    <div class="absolute inset-0">
                        ...
                        <div class="flex-1 max-h-screen xl:overflow-y-auto">
                            <nav>
                                <ul>
                                    <li v-for="link of docs.toc" :key="link.id" :class="{ 'pl-8': link.depth === 3, 'pl-5 font-bold': link.depth === 2 }" class="group flex items-center px-3 text-sm leading-8 hover:text-yellow-900 hover:bg-yellow-100 focus:outline-none focus:bg-yellow-200 transition ease-in-out duration-150">
