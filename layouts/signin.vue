...
<div id="app">
    ...
    <div class="bg-yellow-50 min-h-screen flex-col  justify-center flex lg:h-screen w-screen lg:overflow-hidden xs:flex-col lg:flex-row">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md py-40">
            <a href="/#" class="font-medium text-yellow-600 hover:text-yellow-500">
             <img
                            ...
                            <h2 class="mt-6 text-center text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-yellow-600 to-indigo-800">
    ...
    <div class="px-4  sm:rounded-lg sm:px-10">
        ...
        <div class="hidden lg:block relative bg-gradient-to-br bg-yellow-200 lg:w-1/2 lg:h-full">
